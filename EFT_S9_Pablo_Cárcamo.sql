...
-- Privilegios para PRY2205_EFT_DES
...
-- Otorgar rol PRY2205_ROL_C a PRY2205_EFT_CON
...
-- Limpiar datos de la tabla para test
-- DELETE FROM PRY2205_EFT.T_ANALISIS_TARJETAS;
...
-- Drop index para test
-- DROP INDEX idx_syntrans;
...
-- Drop vista para test
-- DROP VIEW PRY2205_EFT_DES.VW_ANALISIS_DEUDORES_PERIODO;
